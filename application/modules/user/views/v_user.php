        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="admintab-wrap edu-tab1">
                ...
                <ul  class="nav nav-tabs custom-menu-wrap custon-tab-menu-style1">
                    <li class="active"><a data-toggle="tab" href="#TabProject"><span class="edu-icon edu-analytics tab-custon-ic"></span>Peminjaman Dokumen</a>
                    </li>

                    <li><a data-toggle="tab" href="#TabDetails"><span class="edu-icon edu-analytics-arrow tab-custon-ic"></span>Pelunasan Dokumen</a>
                    </li>
                </ul>
                                ...
                                <form method="post" id="formpinjam">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <label class="login2 pull-left pull-right-pro"><?php echo $_SESSION['nama_user'];?></label>
                                            </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">Tanggal Peminjaman : </label>
                                            </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">Tanggal Pengembalian : </label>
                                            </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">Apa Yang di Pinjam : </label>
                                            </div>
                                            <div class="col-lg-6 col-md-9 col-sm-9 col-xs-12">
                                                <textarea type="text" class="form-control" name="apa" style="height:100px;" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">Alasan Peminjaman : </label>
                                            </div>
                                            <div class="col-lg-6 col-md-9 col-sm-9 col-xs-12">
                                                <textarea type="text" class="form-control" name="alasan" style="height:100px;" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form method="post" id="formlunas">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="login2 pull-right pull-right-pro">Tanggal Pelunasan : </label>
                                            </div>

                                            <div class="col-lg-3 col-md-9 col-sm-9 col-xs-12">
                                                
                                                <input type="date" name="tgllunas" class="form-control" required>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12" style="text-align: right;">
                                                <button class="btn btn-custon-rounded-four btn-success" type="button" onclick="pelunasan()">Submit</button>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function insert(){
        var a = $("input[name='mulai']").val();
        var e = $("input[name='selesai']").val();
        var b = $("input[name='iddebitur']").val();
        var c = $("textarea[name='apa']").val();
        var d = $("textarea[name='alasan']").val();
        ...
        if( (a == "") || (b == "") || (c == "") || (d == "") || (e == "") ){
            ...
            var target = ("<?php  echo base_url('user/pinjambaru')?>");
            ...
            $.ajax({
                ...
                .done(function(respond){
                    ...
                    if(json.error == 0){
                        ...
                        var url = "<?php echo base_url('user/cetakpdfpeminjaman?iddeb=')?>"+json.iddeb;
                        // console.log(url);
        ...
        $("#konten").load("<?php echo base_url('user/main');?>");
    }
    ...
    function modal(){
        ...
        var target = "<?php echo base_url('user/daftaruser')?>";
    ...
    function pelunasan(){
        var a = $("input[name='tgllunas']").val();
        var b = $("input[name='iddebitur']").val();

            if((a=="")||(b=="")){

                swal("Mohon Lengkapi Pengisian","","error");
                ...
                $.ajax({
                    url: '<?php echo base_url('user/pelunasandebitur') ?>',
                    type: 'POST',
                    data: data,
                })
                .done(function(e) {
                    ...
                    if(json.error==1){
                        ...
                        swal("Gagal Memasukkan Data","","error");

                    } else {
                        
                        swal("Berhasil Memasukkan Data","","success");
                    }
