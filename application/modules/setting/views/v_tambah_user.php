                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12" style="text-align: right;">
                                <button class="btn btn-custon-rounded-four btn-success" type="button" onclick="addnew()">Add</button>
                            </div>
                        </div>
                    </div>
        ...
        if( (nama == "") || (username == "") || (email == "") || (password == "") ){
            ...
            if(password != password2){
               ...
               $("input[type='password']").attr('style', 'border: 1px solid #ed5565;');
                ...
                var target = "<?php  echo base_url('setting/addnew')?>";
                ...
                $.post(target, data , function(e) {
                    ...
                    if(json.status == "ada"){
                        ...
                        swal("Berhasil Input User Baru", { icon: "success", });
